...
// 4. push()
scores.push(70);
console.log(scores); // [ 100, 90, 70 ]
// 5. shift()
let firstScore = scores.shift();  // 첫 번쨰 element를 삭제하고 그 값을 return
console.log(scores);  // 결과값 : [90, 70]
console.log(firstScore); // 결과값 : 100
// 6. unshift()
let newIndex = scores.unshift(4.5); // 0번지에 새 element 추가하고 +1 된 새로운 lengh를 return
...
// 8. splice()
scores.splice(1, 0, 'B+', '100점', 4.0);  // 1번지에 아무것도 삭제하지 않고(0), 'B+', '100점', 4.0이라는 3 개의 element를 scores 배열에 추가한다는 으미.
...
let modifiedSerList = userList.map(function(user){
  return {
...
console.log(modifiedSerList);
console.log(userList);
/**
 * [
  { fullName: '김영', lName: '김', fName: '영', email: 'a@test.com' },
  { fullName: '김일', lName: '김', fName: '일', email: 'b@test.com' },
  { fullName: '김이', lName: '김', fName: '이', email: 'c@test.com' },
  { fullName: '김삼', lName: '김', fName: '삼', email: 'd@test.com' },
  { fullName: '김사', lName: '김', fName: '사', email: 'e@test.com' }
]
