...
/**
 * object 상에서는 변수에 할당된 값을 key로 치환해서 사용하는 것을 불가능합니다.
 * 
 * 하지만 object literal syntax extension을 사용하면 object의 키로 변수에 할당된 '문자열'값을 사용할 수 있습니다. 대괄호([]) 사용합니다.
 */
...
/**
 * Objcet의 key를 동적으로 생성가능할 수 있다는 점 : input 태그를 통해서 객체의 key를 생성할 수 있겠네요.
 * 
 */